module.exports = {
    ...
    PLAYBOOK_DISCOVERY_ART : "The Product, Design, and Engineering lifespan is relatively short in Technology, but the art of the process and craft continues.",
    ...
    PLAYBOOK_DISCOVERY_PRODUCT_WHY : "Why do this? ✅ Clear goal and success metrics of MVP in a true 'ready for dev' state in GANNT Chart. ❌ Avoids Slack whirlwind after handoff, missed target launches, unable to measure outcomes.",
    ...
    PLAYBOOK_DISCOVERY_GANNT : "GANNT Chart: public timeline and linked order of operations by teams",
