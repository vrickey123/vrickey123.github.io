module.exports = {
    ...
    PLAYBOOK_DISCOVERY_ENGINEERING_TWO_PAGER : "Technical Two Pagers (optional): tech specs for each platform (iOS, Android, Web, Backend) with documentation links and code snippets for peer review before coding even starts",
