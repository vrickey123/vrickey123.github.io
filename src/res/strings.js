module.exports = {
    ...
    PLAYBOOK_DISCOVERY_SUBTITLE : "Create documentation for MVP to parallelize teams and automate tests",
    PLAYBOOK_DISCOVERY_GOAL : "The goal of discovery is to create the Product, Design, and Engineering documentation required to drive large teams in parallel with the ability to automate tests for each task.",
    ...
    PLAYBOOK_DISCOVERY_ENGINEERING_TWO_PAGER : "Technical Two Pager (optional): documentation links and code snippet for peer review before coding even starts",
