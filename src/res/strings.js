module.exports = {
    ...
    PLAYBOOK_CONTINUOUS_DELIVERY : "Continuous Delivery",
    PLAYBOOK_THREE_ENV_SUBTITLE : "Parallelize Engineering & QA in DEV, INT, PROD",
    PLAYBOOK_THREE_ENV_TEST : "Test Environments",
    PLAYBOOK_THREE_ENV_LEAD : "When the app, backend, and web teams must work together to deliver features in parallel; a three-environment setup enables Engineering & QA to develop features and bug fixes in parallel.",
    ...
    PLAYBOOK_APP_BRANCHING_STRATEGY_LEAD : "Scaled Trunk-Based Developments offers the most intuitive and easy-to-maintain approach for app development and release.",
