module.exports = {
    ...
    PLAYBOOK_THREE_ENV_SUMMARY : "This works by separating an unstable DEV environment from a stable INT environment for internal users; and a PROD environment for public users. Each environment has a respective role and test suite rules for promotion.",
    ...
    PLAYBOOK_APP_BRANCHING_STRATEGY_HOTFIX : "The Release branches are not merged back to main and only open to HotFixes, which avoids conflict resolution headaches and related regressions.",
    PLAYBOOK_APP_TRUNK_CAPTION : "Scaled Trunk-Based Development",
    PLAYBOOK_TEST_PYRAMID : "Test Pyramid",
    PLAYBOOK_TEST_PYRAMID_SUBTITLE : "Human QA and Automated Test Strategy from Unit to Integration to UI",
