module.exports = {
    ...
    TABLE_HEADER_IMPACT : "Impact Area",
    TABLE_HEADER_RESULT : "Result",
    TABLE_ITEM_SUBSCRIPTION_DOMAIN : "Subscription & Ad Tech",
    TABLE_ITEM_SUBSCRIPTION_TECHNICAL : "7 subscription flows drive 4 user states & dynamic paywall",
    ...
    TABLE_ITEM_ARCHITECTURE_RESULT : "Consolidates 4 teams and codebases into 1: eliminate redundancy, maximize reuse",
    TABLE_ITEM_TECH_DOMAIN : "Tech Stack",
    TABLE_ITEM_TECH_TECHNICAL : "84% Java to 91% Kotlin",
    TABLE_ITEM_TECH_IMPACT : "Innovation, Hiring",
    TABLE_ITEM_TECH_RESULT : "Support latest OS features and remain attractive destination for talent",
    TABLE_ITEM_UI_DOMAIN : "UI",
    TABLE_ITEM_UI_TECHNICAL : "100% View to 100% Compose",
    TABLE_ITEM_UI_IMPACT : "Time to market, Pixel Perfect UI",
    TABLE_ITEM_UI_RESULT : "Faster to develop, test, release, and maintain complex UI states; Design team is happy",
    TABLE_ITEM_RELEASE_DOMAIN : "Release Automation",
    ...
    TABLE_ITEM_TESTING_DOMAIN : "Automated Testing",
    TABLE_ITEM_TESTING_TECHNICAL : "661% increase in unit test coverage: 91 to 693 unit tests",
    TABLE_ITEM_TESTING_IMPACT : "Resiliency",
    TABLE_ITEM_TESTING_RESULT : "Automate ability to catch errors in app states not easily reproduced by human QA testers ",
